...
setCustomClasses:function(){"left"==this.calendarPlacement&&this.picker.addClass("datepicker-left")}};d.fn.datepicker=function(a,b){var c=[],e=this.each(function(){var e=d(this),f=e.data("datepicker"),g="object"===typeof a&&a;"string"===typeof a?f&&(e=f[a](b),"undefined"!==typeof e&&c.push(e)):f||e.data("datepicker",new l(this,d.extend({},d.fn.datepicker.defaults,g)))});return 1==c.length?c[0]:c.length?c:e};d.fn.datepicker.defaults={container:"body"};d.fn.datepicker.Constructor=l;var g={modes:[{clsName:"days",
