...
!function ($, moment, undefined) {
    ...
    $.fn.mdatepicker = function (option, val) {
        var results = [];
        var chain = this.each(function () {
            ...
            if (typeof option === 'string') {
                ...
                $this.data('datepicker', (data = new Datepicker(this, $.extend({}, $.fn.mdatepicker.defaults, options))));
            }
        });
    ...
    $.fn.mdatepicker.defaults = {
    	container : 'body'
    };
    $.fn.mdatepicker.Constructor = Datepicker;
